...
from networks import FullModelWithSorting, SeqCropsModel
from networks import FullModelWithNoSorting, FeatureExtractor



def prepare_the_run_B8(config ,B5_CP_A_path):
    ...
    model = FullModelWithSorting( model1 , config['Modelling']['num_classes']).to(device)
