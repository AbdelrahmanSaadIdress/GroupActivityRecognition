...
class FullFrameNoSeqDataset(Dataset):
    def __init__(self, annots, frames_annots_path, transform, matches):
        """
        Args:
    ...
    def __getitem__(self, idx):
        ...
        return frame, label   # tensor with shape (3, H, W)   ,    scalar tensor    